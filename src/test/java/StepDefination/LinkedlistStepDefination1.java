...
public class LinkedlistStepDefination1 {
        WebDriver driver;
		TestContextSetup testcontextsetup;
		LinkedlistPageObject1 linkedlistpageobj; 
        Run_PythonCodes runpythoncode;
		landingpageobjects landingpage;
public LinkedlistStepDefination1(TestContextSetup testcontextsetup)
		{
	 ...
	 @Given("The user is already on the Try Editor page of Linked List")
	  ...
	  public void topics_covered_section_is_displayed_on_left_side_of_the_page() 
		...
		@When("User writes Python code for Linked list given sheetname {string} rownumber {int} and columnumber {int}")
		public void user_writes_python_code_for_linked_list_given_sheetname_rownumber_and_columnumber(String sheetname, Integer rownumber, Integer columnumber) throws InterruptedException 
		{
		...
		@When("User writes Invalid Python code for Linked list given sheetname {string} rownumber {int} and columnumber {int}")
		public void user_writes_invalid_python_code_given_sheetname_rownumber_and_columnumber(String sheetname, Integer rownumber, Integer columnumber) throws InterruptedException
		{
			String python_code = ExcelReader.getExcelValue(sheetname, rownumber, columnumber);
			System.out.println("First");
			linkedlistpageobj.getPythonCode_from_excel(python_code);
	 ...
	 @Given("The User is on the Try Editor page of Creating Linked list")
		public void the_user_is_on_the_try_editor_page_of_creating_linked_list() 
		{
			linkedlistpageobj.click_CreatingLinkedlist();
			linkedlistpageobj.click_tryHere_on_CreatingLinkedlist();
			System.out.println("User is on the Try Editor page of Creating linked list section");
	  ...
	  @Then("Topics covered section is displayed on left side of the creating linked list page")
	    public void topics_covered_section_is_displayed_on_left_side_of_the_creating_linked_list_page() {
		...
		public void the_user_clicks_try_here_button_of_Types_of_linked_list_page()
		{
		...
		@When("User writes Python code for Linked list from given sheetname {string} rownumber {int} and columnumber {int}")
		public void user_writes_python_code_for_Linked_list_from_given_sheetname_rownumber_and_columnumber(String sheetname, Integer rownumber, Integer columnumber) throws InterruptedException 
		{
			String python_code = ExcelReader.getExcelValue(sheetname, rownumber, columnumber);
			System.out.println("First");
			linkedlistpageobj.getPythonCode_from_excel(python_code);
		 ...
		 public void user_click_on_run_button_under_types_of_linked_list_page()
		 {
			 runpythoncode.run_button();
		...
		public void user_gets_output_in_the_output_panel_under__types_of_linked_list()
		{
			runpythoncode.Ouptput_ValidCode();
		}
		...
		public void the_user_is_on_the_try_editor_page_of_linked_list() 
		{
			linkedlistpageobj.click_TypesofLinkedlist();
			linkedlistpageobj.click_tryhere();
			System.out.println("User is on the Try Editor page of Types of Linked list section");
	    }
	   ...
	   /* @And ("User click on Run button of Linked list")
		public void user_click_on_run_button_of_linked_list();
		{
		 ...
		 /*@Then("User sees output in the output panel under Types of Linked list")
		 public void user_sees_output_in_the_output_panel_under_types_of_linked_list
		 {
	...
	*/
	...
	public void The_user_is_On_the_linked_list_page_after_logged_in() {
		...
		{
			/*String actual_title = landingpage.get_Title();
			String expected_title = "Implement Linked List in Python";
			assertEquals(expected_title, actual_title);
			System.out.println("User is on the " + expected_title + " Page");*/
			String actual_tit= landingpage.get_Title();
			String exp_tit = "Implement Linked List in Python";
			assertEquals(exp_tit, actual_tit);
			System.out.println("User is on the " + actual_tit+ " Page");
		}
		...
		public void the_user_clicks_try_here_button_of_Implement_linked_list_page() 
			{
			          linkedlistpageobj.click_tryhere();
			}
		...
		public void the_user_redirected_to_implement_linked_list_in_python_page_having_an_try_editor_with_a_run_button_to_test() {
			...
			String Expected_tit = "Assessment";
			assertEquals(Expected_tit, actual_tit);
			System.out.println("User is on the " + actual_tit + " Page Implementation of Linked list in Python section");
		}
		/*@When("The User clicks Try Here button of Linked list page")
		public void the_user_clicks_try_here_button_of_linked_list_page()
		{
	   ...
	   @Then("It should redirect to of Implement Linked list in Python")
		...
		public void the_user_should_be_directed_to_traversal_page_of_linked_list() {
			String actual_tit = landingpage.get_Title();
			String exp_tit = "Traversal";
			Assert.assertEquals(exp_tit, actual_tit, "User wasn't naviagated to expected page");

		}

		@Given("The user is on the Traversal page of Linked list")
		public void the_user_is_on_the_traversal_page_of_linked_list() {
			linkedlistpageobj.click_Traversal();
		   /*String actual_tit = landingpage.get_Title();
			String exp_tit = "Traversal";
		...
		public void the_user_clicks_try_here_button_on_traversal_page_of_linked_list() {
		    linkedlistpageobj.click_tryhere();
		}

		@Then("The user redirected to Traversal page of Linked list having an tryEditor with a Run button to test")
		public void the_user_redirected_to_traversal_page_of_linked_list_having_an_try_editor_with_a_run_button_to_test() {
			String actual_tit = landingpage.get_Title();
		...
		public void the_user_should_be_directed_to_insertion_page() {
			...
			String actual_title = landingpage.get_Title();
			String expected_title = "Insertion";
			assertEquals(expected_title, actual_title);
			System.out.println("User is on the " + actual_title + " Page");
		...
		public void the_user_redirected_to_insertion_page_having_an_try_editor_with_a_run_button_to_test() {
			...
			String Exp_tit = "Assessment";
			assertEquals(Exp_tit, actual_tit);
			System.out.println("User is on the " + actual_tit + " Page of Insertion section");
		}
		...
		public void the_user_should_be_directed_to_deletion_page() {
			/*String actual_tit1 = landingpage.get_Title();
			String exp_tit1 = "Deletion";
			Assert.assertEquals(exp_tit1, actual_tit1, "User wasn't naviagated to expected page");
			System.out.println("User navigated to " + actual_tit1);*/
			String actual_tit = landingpage.get_Title();
			String exp_tit = "Deletion";
			Assert.assertEquals(exp_tit, actual_tit, "User wasn't naviagated to expected page");
